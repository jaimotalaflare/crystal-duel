...
export function figure(c,extra=''){return `<div class="figure ${extra} ${c.art==='beast'?'beast':''}" style="--sprite-x:${MAGES[c.element].idx*25}%;--sprite-y:${c.art==='beast'?100:0}%;--seal:${c.seal||0}" aria-hidden="true"></div>`}
